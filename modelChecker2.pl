/*************************************************************************
    ...
    by xiyuan.gao
    new contents of Three-place predicates& Four-place predicates have been added
    in order to check semantic representation of 10 sentences from clsem-ex3-sose2019
*************************************************************************/
...
/*========================================================================
   Three-place predicates. to be used in clsem-ex3-sose2019
========================================================================*/

satisfy(Formula,model(D,F),G,pos):-
   nonvar(Formula),
   compose(Formula,Symbol,[Arg1,Arg2,Arg3]),
   \+ memberList(Symbol,[eq,imp,or,and,some,all]),
   i(Arg1,model(D,F),G,Value1),
   i(Arg2,model(D,F),G,Value2), 
   i(Arg3,model(D,F),G,Value3),
   memberList(f(3,Symbol,Values),F), 
   memberList((Value1,Value2,Value3),Values).
...
/*========================================================================
   Four-place predicates. to be used in clsem-ex3-sose2019
========================================================================*/

satisfy(Formula,model(D,F),G,pos):-
   nonvar(Formula),
   compose(Formula,Symbol,[Arg1,Arg2,Arg3,Arg4]),
   \+ memberList(Symbol,[eq,imp,or,and,some,all]),
   i(Arg1,model(D,F),G,Value1),
   i(Arg2,model(D,F),G,Value2), 
   i(Arg3,model(D,F),G,Value3),
   i(Arg4,model(D,F),G,Value4),
